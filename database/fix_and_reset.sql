-- ============================================================
-- FeedbackIQ — COMPLETE RESET SCRIPT
-- Run this ONCE in VS Code SQL editor to fix everything
-- ============================================================
...
-- Step 2: Drop ALL old and new tables (covers both 'feedback' and 'feedbacks')
DROP TABLE IF EXISTS flagged_feedbacks;
DROP TABLE IF EXISTS product_sentiment_scores;
DROP TABLE IF EXISTS feedback;       -- old table name (without s)
DROP TABLE IF EXISTS feedbacks;      -- new table name (with s)
DROP TABLE IF EXISTS products;

-- Step 3: Drop old triggers/procedures/views if any exist
...
SELECT '✅ Feedbacks count:' AS status;
